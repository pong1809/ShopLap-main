...
public class XN extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       List<Cart> product = dao.getProductByIDA(Integer.parseInt(ida));
        
        // Cập nhật số lượng sản phẩm và trạng thái của đơn hàng
        for (Cart p : product) {
            dao.updateSLCsaukhimua(Integer.parseInt(ida),p.getSlc(), p.getAmount(), p.getDaban(), String.valueOf(p.getPid()));
        }
        ...
        session.setAttribute("thongbao", "Xác nhận thành công");
